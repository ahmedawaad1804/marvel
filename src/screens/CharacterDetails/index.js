...
import {View, Text, Animated, Image, ScrollView, Pressable} from 'react-native';
...
function CharacterDetails(props) {
  ...
  return (
    <View style={styles.container}>
      {overlayImage && (
        <Pressable style={styles.overlayImageContainer} onPress={toogleImage}>
      ...
      <ScrollView
        ...
        {arrayOfCategories.map(categoryName =>
          characterDetails[categoryName].available ? (
